$(document).ready(function() {
  ...
  $('#info-step').click(function(e) {
    ...
    $('#red-step').click(function(e) {
      e.preventDefault();
      if ($("#red-input").prop('selectedIndex') == 0) {
        $('#red-alert').show(500);
      } else {
        $('#red-alert').hide();
    ...
    $('#ma-step').click(function(e) {
      e.preventDefault();
      if ($('#auswahlmitgliedschaft').prop('selectedIndex') == 0) {
        $('#ma-alert').show(500);
      } else if (jQuery('#auswahlmitgliedschaft').val() == "Open Session Mitgliedschaft" || jQuery('#auswahlmitgliedschaft').val() == "Passive Mitgliedschaft" || jQuery('#auswahlmitgliedschaft').val() == "Mitarbeiter Mitgliedschaft") {
        $('#ma-alert').hide();
