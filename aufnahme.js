...
jQuery(document).ready(function() {
  ...
  if (id == "mitarbeiter") {
    jQuery('#auswahlmitgliedschaft').append('<option value="Mitarbeiter Mitgliedschaft">Mitarbeiter Mitgliedschaft</option>');
  }
  ...
  jQuery("#mengekurse, #uploadfile, #auswahlmitgliedschaft, #zopen, #erabfrage, #er, #ner").on('change', function() {
    ...
    if (jQuery('#auswahlmitgliedschaft').val() == "Mitarbeiter Mitgliedschaft") {
      if (jQuery('#red-input option:selected').val() == "Ermäßigung") {
        jQuery('#summe').text('13');
      } else if (jQuery('#red-input option:selected').val() == "Keine Ermäßigung") {
        jQuery('#summe').text('13');
      } else {
        jQuery('#summe').text('');
...
jQuery("#kurs1, #zparkour1, #mengekurse").on('change', function() {
  if (jQuery('#kurs1').val() == "Parkour") {
    ...
    jQuery('#zparkour1').hide();
    jQuery('#tag1 option:eq(2), #tag1 option:eq(4), #tag1 option:eq(6)').hide();
    jQuery('#tag1 option:eq(1), #tag1 option:eq(3), #tag1 option:eq(5)').show();
  }
});
jQuery("#kurs2, #zparkour2, #mengekurse").on('change', function() {
  if (jQuery('#kurs2').val() == "Parkour") {
    ...
    jQuery('#zparkour2').hide();
    jQuery('#tag2 option:eq(2), #tag2 option:eq(4), #tag2 option:eq(6)').hide();
    jQuery('#tag2 option:eq(1), #tag2 option:eq(3), #tag2 option:eq(5)').show();
  }
});
jQuery("#kurs3, #zparkour3, #mengekurse").on('change', function() {
  if (jQuery('#kurs3').val() == "Parkour") {
    ...
    jQuery('#zparkour3').hide();
    jQuery('#tag3 option:eq(2), #tag3 option:eq(4), #tag3 option:eq(6)').hide();
    jQuery('#tag3 option:eq(1), #tag3 option:eq(3), #tag3 option:eq(5)').show();
  }
});
